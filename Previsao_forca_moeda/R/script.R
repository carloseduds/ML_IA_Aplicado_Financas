...
currencies <- read.csv(file = "../data/raw/currencies.csv", header = TRUE)
commodities <- read.csv(file = "../data/raw/commodities.csv", header = TRUE)
View(currencies)
View(commodities)
...
#Salvar Plot
pdf("../reports/figures/teste2.pdf", width = 20, height = 14)
